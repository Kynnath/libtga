...
${OBJECTDIR}/src/TGA/Image.o: src/TGA/Image.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I../libtools/src -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TGA/Image.o src/TGA/Image.cpp

${OBJECTDIR}/src/TGA/tga.o: src/TGA/tga.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/TGA
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I../libtools/src -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TGA/tga.o src/TGA/tga.cpp
